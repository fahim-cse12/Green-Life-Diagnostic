...
namespace Repository
{
    public class RepositoryManager : IRepositoryManager
    {
        ...
        private readonly Lazy<IPatientInvestigationDetailRepository> _investigationDetailRepository;
        ...
        public RepositoryManager(RepositoryContext repositoryContext, IDbConnection dbConnection)
        {
            ...
            _investigationDetailRepository = new Lazy<IPatientInvestigationDetailRepository>(() => new PatientInvestigationDetailRepository(repositoryContext));
        ...
        public IPatientInvestigationDetailRepository InvestigationDetailsRepository => _investigationDetailRepository.Value;
