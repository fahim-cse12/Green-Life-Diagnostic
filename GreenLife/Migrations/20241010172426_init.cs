        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeeForNewPatient = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    FeeForOldPatient = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Speciality = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ScheduledDay = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FinancialRecords", x => x.FinancialId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientUniqueId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DoctorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    PatientInvestigationUniqueId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PatientName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PatientAge = table.Column<int>(type: "int", nullable: false),
                    PatientMobileNo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientInvestigations", x => x.PatientInvestigationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientUniqueId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PatientInvestigationDetailId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PatientInvestigationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    InvestigationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientInvestigationDetails", x => x.PatientInvestigationDetailId);
                    table.ForeignKey(
                        name: "FK_PatientInvestigationDetails_PatientInvestigations_PatientInvestigationId",
                        column: x => x.PatientInvestigationId,
                        principalTable: "PatientInvestigations",
                        principalColumn: "PatientInvestigationId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientInvestigationDetails_PatientInvestigationId",
                table: "PatientInvestigationDetails",
